...
export GPU=0
export models="R_50_C4_1x R_50_C4_1x_pre R_50_FPN_1x R_50_FPN_1x_pre R_101_FPN_1x R_101_FPN_1x_pre X_101_32x8d_FPN_1x X_101_32x8d_FPN_1x_pre"
for run in `seq 1 30`;   
do   
for model in  ${models} ;    
do    
...
# [ORIGINAL] Faster R-CNN and Mask R-CNN in PyTorch 1.0
